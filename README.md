...
Run the script on an offline system, provide either your seed phrase or a private key, confirm the requested words, and enter destination addresses for each supported coin (BTC, ETH, and LTC by default).
After validation, you can use your preferred blockchain library to build and broadcast the transactions from your recovered keys to the addresses you entered.
